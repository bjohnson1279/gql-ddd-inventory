...
describe('ManageJournals Use Cases', () => {
  ...
  describe('CreateJournalEntryUseCase', () => {
    it('should throw an error when creating a journal entry with debits not equal to credits (explicit test)', async () => {
      ...
      const input: CreateJournalEntryInput = {
        ...
        description: 'Test explicitly debits not equal to credits',
        method: AccountingMethod.Accrual,
        lines: [
          {
            accountCode: '1000',
            amountCents: 1500, // Debit 15.00
            type: DebitCredit.Debit,
            memo: 'Debit side'
          },
          {
            accountCode: '4000',
            amountCents: 1000, // Credit 10.00 (not equal)
    ...
    it('should test missing error path when debits not equal to credits', async () => {
      const useCase = new CreateJournalEntryUseCase(mockJournalRepo);
      ...
      const input: CreateJournalEntryInput = {
        ...
        tenantId: 'T1',
        date: new Date().toISOString(),
        description: 'Test debits not equal to credits completely new',
        method: AccountingMethod.Accrual,
        lines: [
          {
            accountCode: '1000',
    ...
    it('should throw an error when creating a journal entry with debits not equal to credits', async () => {
      ...
      const input: CreateJournalEntryInput = {
        ...
        lines: [
          ...
          {
            accountCode: '4000', // Revenue
            amountCents: 99, // Credits not equal to debit
            type: DebitCredit.Credit,
            memo: 'Credit side'
          }
        ]
